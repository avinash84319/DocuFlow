...
export function ApiNode({ id, data, selected }: CustomNodeProps) {
  return (
    <div className={`px-4 py-2 shadow-md rounded-md bg-white border-2 min-w-[150px] text-center relative group ${selected ? 'border-blue-700' : 'border-blue-400'}`}>
      ...
      <div className="font-bold text-xs uppercase tracking-wider text-blue-600 mb-1">API</div>
